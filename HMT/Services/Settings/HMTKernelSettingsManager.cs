...
namespace HMT.KernelSettings
{
    ...
    public class HMTKernelSettingsManager
    {
        ...
        private HMTKernelSettingsStorage _kernelSettingsStorage = new HMTKernelSettingsStorage();
        ...
        {
            _kernelSettingsStorage.LoadSettings(package);
        ...
        public void LoadDefaultSettings(ExtensionTemplateDefaultScheme extensionTemplateDefaultScheme, AsyncPackage package = null)
        {
            ...
            switch (extensionTemplateDefaultScheme)
            {
                case ExtensionTemplateDefaultScheme.DefaultWithUnderscore:
                    ...
                    LoadSettingsFromFormControlData(templateStringControl, package);
                    break;
            }
        }
